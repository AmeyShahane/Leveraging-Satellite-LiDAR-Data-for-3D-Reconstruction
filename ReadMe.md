...
* You can use data downloader script from GEDI Finder to get required data. Alternatively you can visit the [NASA Earthdata Search website](https://search.earthdata.nasa.gov/search) to download the required data
